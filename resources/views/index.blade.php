                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="{{ route('index') }}"> <img
                                src="{{ asset('img/landing/logo.png') }}" alt="logo"> Novo Consultorio
                        </a>
                        ...
                        <a class="btn_2 d-none d-lg-block" href="{{ route('login') }}">Testar Sistema</a>
                ...
                <div class="col-lg-5 col-xl-5">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <p>Independente da sua segmentação médica. Novo Consultorio foi feito e
                                pensado especialmene para você que trabalha AJUDANDO PESSOAS.</p>
                            <a href="{{ route('contato') }}" class="btn_2">Entre em Contato</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
